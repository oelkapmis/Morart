package com.example.morart.Utils
...
object BitmapUtils {
    ...
    fun insertImage(contentResolver: ContentResolver, source:Bitmap?, title:String, description: String):String?{
        ...
        try{
            ...
            if(source != null){
                ...
                storeThumbnail(contentResolver, miniThumb, id, 50f, 50f, MediaStore.Images.Thumbnails.MINI_KIND)
            }else{
    ...
    private fun storeThumbnail(contentResolver: ContentResolver, source: Bitmap?, id: Long, width: Float, height: Float, miniKind: Int): Bitmap? {
        val matrix = Matrix()
        ...
        values.put(MediaStore.Images.Thumbnails.KIND, miniKind)
